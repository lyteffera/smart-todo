...
public class ToDo extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException 
  {
      ...
      String id = null;
      if(parsedBodyData.getChild("id") != null)
        id = parsedBodyData.getChild("id").getData();
      Key key = KeyFactory.stringToKey(id);
      Entity entity = null;
      try{
        entity = datastore.get(key);
        String status = ((String)entity.getProperty("status")).toLowerCase().equals("open")?"closed":"open";
